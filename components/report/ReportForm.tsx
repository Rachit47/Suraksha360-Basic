      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        >
          <div className="flex flex-col items-center space-y-2">
            ...
            <span className="text-xs text-zinc-400">Urgent Action Needed</span>
          </div>
        </button>
        ...
        >
          <div className="flex flex-col items-center space-y-2">
            ...
            <span className="text-xs text-zinc-400">General Inquiry</span>
          </div>
        </button>
      </div>
            ...
            <div className="space-y-4">
              <div className="w-full h-48 relative rounded-lg overflow-hidden">
                <Image
                  src={image}
                  alt="Preview"
                  layout="responsive" // or layout="fill" depending on your design
                  width={500} // Provide a width based on your design
                  height={300} // Provide a height based on your design
                  className="object-cover" // You can keep any utility classes for styling
                />
              </div>
