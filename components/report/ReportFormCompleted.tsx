...
// Definition of the type for the report data
    ...
    <div className="text-center space-y-6">
      ...
      <div className="bg-zinc-800/50 rounded-lg p-6 max-w-md mx-auto">
        ...
        <div className="bg-zinc-900 rounded p-3">
          <code className="text-blue-400">{reportId}</code>
        </div>
        <p className="mt-2 text-sm text-zinc-400">
      ...
      <div className="pt-4">
        <button
          ...
          className="inline-flex items-center justify-center rounded-lg bg-blue-500 px-4 py-2 text-sm font-medium text-white hover:bg-blue-400"
        >
          Return to Home
        </button>
      </div>
